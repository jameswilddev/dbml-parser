...
final class LogParserTargetTest extends TestCase
{
  ...
  public function test_logs_all_events()
  {
    ...
    $logParserTarget->foreignKeyConstraint(
      'Test Foreign Key Constraint Referencing Table Name Or Alias',
      883,
      632,
      644,
      512,
      'Test Foreign Key Constraint Referencing Column Name',
      38,
      92,
      25,
      70,
      'Test Foreign Key Constraint Referenced Table Name Or Alias',
      104,
      160,
      80,
      98,
      'Test Foreign Key Constraint Referenced Column Name',
      401,
      5022,
      46,
      70
