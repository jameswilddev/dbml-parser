...
final class LogTokenizerTarget implements TokenizerTarget
{
  ...
  {
    $this->events []= new TokenEvent($line, $startColumn, $endColumn, $content);
  }
  ...
  {
    $this->events []= new QuotedTokenEvent($line, $startColumn, $endColumn, $content);
  }
  ...
  {
    $this->events []= new StringLiteralEvent($startLine, $startColumn, $endLine, $endColumn, $content);
  }
  ...
  {
    $this->events []= new BacktickStringLiteralEvent($startLine, $startColumn, $endLine, $endColumn, $content);
  }
  ...
  {
    $this->events []= new UnknownEvent($startLine, $startColumn, $endLine, $endColumn, $content);
  }
}
