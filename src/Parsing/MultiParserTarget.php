...
/**
 * Forwards events to multiple ParserTargets.
 */
final class MultiParserTarget implements ParserTarget
{
  /**
   * @var array $targets An array of ParserTargets to pass to.
   */
  private $targets;

  /**
   * @param array $targets An array of ParserTargets to pass to.
   */
  ...
  public function table($name, $nameStartLine, $nameStartColumn, $nameEndLine, $nameEndColumn)
  {
    foreach ($this->targets as $target) {
      $target->table($name, $nameStartLine, $nameStartColumn, $nameEndLine, $nameEndColumn);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->tableAlias($tableName, $name, $nameStartLine, $nameStartColumn, $nameEndLine, $nameEndColumn);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->tableNote($tableName, $content, $contentStartLine, $contentStartColumn, $contentEndLine, $contentEndColumn);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->column($tableName, $name, $nameStartLine, $nameStartColumn, $nameEndLine, $nameEndColumn, $type, $size);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->columnNote($tableName, $columnName, $content, $contentStartLine, $contentStartColumn, $contentEndLine, $contentEndColumn);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->columnPrimaryKey($tableName, $columnName);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->columnIncrement($tableName, $columnName);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->columnNotNull($tableName, $columnName);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->columnConstantDefault($tableName, $columnName, $content, $contentStartLine, $contentStartColumn, $contentEndLine, $contentEndColumn);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->columnCalculatedDefault($tableName, $columnName, $content, $contentStartLine, $contentStartColumn, $contentEndLine, $contentEndColumn);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->index($tableName, $columns, $name, $nameStartLine, $nameStartColumn, $nameEndLine, $nameEndColumn, $unique);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->enum($name, $nameStartLine, $nameStartColumn, $nameEndLine, $nameEndColumn);
    }
  }
  ...
  {
    foreach ($this->targets as $target) {
      $target->enumValue($enumName, $name, $nameStartLine, $nameStartColumn, $nameEndLine, $nameEndColumn);
    }
  }
